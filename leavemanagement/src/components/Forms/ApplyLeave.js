...
export default function ApplyLeave({ toast }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (isNaN(formData.form_duration)) {
      toast.error(
        "Error, Check the duration again",
    ...
    try {
      const resp = await httpClient.post(
        `${process.env.REACT_APP_API_HOST}/apply_leave`,
        {
          data: formData,
        }
      );
      ...
      toast.error(
        "Leave Application Unssucessful",
        toast.POSITION.BOTTOM_RIGHT
      );
    }
    setFormLoading(false);
                  ...
                  <div className="input-box-al">
                    <div className="details-al">
                      ...
                      <Row className="row-al">
                        ...
                        <Col className="col-al">
                          <legend
                            htmlFor="form_isStation"
                            style={{ fontSize: "18px" }}
                          >
                            Is it a station leave?
                          </legend>
                          <select
                            className="form-control"
                            id="form_isStation"
                      ...
                      <Row className="row-al">
                        ...
                        <Col className="col-al">
                          <legend
                            htmlFor="form_altArrangements"
                            style={{ fontSize: "18px" }}
                          >
                            Alternative Arrangements
                          </legend>
                          <textarea
                            id="form_altArrangements"
                            className="form-control"
                            onChange={(e) => {
                              handleInputChange(e);
                            }}
