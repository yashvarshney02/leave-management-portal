					...
					<Card.Text>
						<form onSubmit={(e) => { handleSubmit(e) }}>
							<Container>
								<Row>
									<Col>
										<legend htmlFor="form_name" style={{fontSize: "18px", fontFamily: "monospace"}}>Name *</legend>
									...
									<Col>
										<legend htmlFor="form_email" style={{fontSize: "18px", fontFamily: "monospace"}}>Email *</legend>
								...
								<Row>
									<Col>
										<legend htmlFor="form_phone" style={{fontSize: "18px", fontFamily: "monospace"}}>Phone Number *</legend>
									...
									<Col>
										<legend htmlFor="form_nature" style={{fontSize: "18px", fontFamily: "monospace"}}>Nature of leave *</legend>
								...
								<Row>
									<Col>
										<legend htmlFor="form_isStation" style={{fontSize: "18px", fontFamily: "monospace"}}>Is station leave? *</legend>
									...
									<Col>
										<legend htmlFor="form_duration" style={{fontSize: "18px", fontFamily: "monospace"}}>Duration of leave *</legend>
										<input type="number" className="form-control" id="form_duration" placeholder="Duration" onChange={(e) => { handleInputChange(e) }} required />
									</Col>
								</Row>
								<Row>
									<Col>
										<legend htmlFor="form_sdate" style={{fontSize: "18px", fontFamily: "monospace"}}>Start Date</legend>
									...
									<Col>
										<legend htmlFor="form_edate" style={{fontSize: "18px", fontFamily: "monospace"}}>End Date</legend>
								...
								<Row>
									<Col>
										<legend htmlFor="form_purpose" style={{fontSize: "18px", fontFamily: "monospace"}}>Purpose of leave *</legend>
										<textarea id="form_purpose" className="form-control" onChange={(e) => { handleInputChange(e) }}>

										</textarea>
									</Col>
									<Col>
										<legend htmlFor="form_altArrangements" style={{fontSize: "18px", fontFamily: "monospace"}}>Alternative Arrangements</legend>
