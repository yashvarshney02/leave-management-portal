							...
							<div>
								<div className="container" id={"first-page-" + leave?.id}>
									...
									<div className="leave-details text-center">
										...
										<div className="row" style={{ border: "1px solid" }}>
											...
											<div className="col-5">{currentUser.name}</div>
										</div>
										<div className="row" style={{ border: "1px solid" }}>
											<div className="col-6">
												पदनाम/ विभाग
										...
										<div className="row leave-details-signature">
											...
											<div className="col-6">
												...
												/>
												<br />
												आवेदक के हमताऺर ददनाॊक सदहत/Signature with date of the
												applicant
											</div>
										</div>
									</div>
								...
								<div className="container" id={"second-page-" + leave?.id}>
									...
									>
										<p>
											<b>
												त्रवभाग कायााऱय / प्रशासलनक अनुभाग द्वारा प्रयोग हेतु/
									...
									<hr />
									{leave?.attached_documents == "" ||
									leave?.attached_documents == undefined ? (
										<p>Attached Documents: No document attached</p>
									) : (
										<p>
											Attached Documents:{" "}
											<a target="_blank" href={leave?.attached_documents}>
												Link
											</a>
										</p>
									)}
