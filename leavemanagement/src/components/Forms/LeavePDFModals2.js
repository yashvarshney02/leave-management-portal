				...
				<div>
					...
					<div className="container" style={{ width: "1000px" }} id={"first-page-" + leave?.id}>
						...
						<div className="row" style={{ display: "flex", alignItems: "center" }}>
							...
							<div className="col-11" style={{ flex: "1 1 auto", textAlign: "center" }}>
								<h3 style={{marginBottom:"0px"}}>भारतीय प्रौद्योगिकी संस्थान रोपड़</h3>
								<h3 style={{marginBottom:"0px"}}>INDIAN INSTITUTE OF TECHNOLOGY ROPAR</h3>
								<p style={{marginBottom:"0px"}}>
									<span style={{fontWeight:"bold"}}>नंगल विभाग रूपनगर,पंजाब-140001</span> / Nangal Road, Rupnagar,
									Punjab-140001
								</p>
								<p style={{marginBottom:"0px"}}>
						...
						<hr style={{border: "2px solid #000000", borderColor:"black", margin:"2px"}} />

						<div className="leave-details text-center">
							<div className="row leave-details-heading">
								<div className="col-3"></div>
								<div className="col-12 text-center">
									<p style={{ fontSize: "15px", marginBottom: "5px", fontWeight: "bold" }}>
										छुट्टी केललए अथवा छुट्टी बढानेहेतुआवेदन / Application for leave or Extension of Leave
									</p>
									<p style={{ fontWeight: "bold", fontSize: "14px", marginBottom: "5px" }} >
										आकस्मिक छुट्टी/ राजपत्रित अवकाश / विशेष आकस्मिक छुट्टि
									</p>
									<p style={{ fontWeight: "bold", fontSize: "14px", marginBottom: "5px" }}>
										(Earned Leave/Half Pay Leave/Extra Ordinary Leave/Commuted Leave/Vacation/Maternity Leave/Paternity Leave/Child Care Leave)
									</p>
								</div>
							</div>

							<div className="row" style={{fontSize:"14px", minHeight:"38.6px"}} >
								<div className="col-6" style={{ textAlign: "left", border: "1px solid" }} >1. आवेदक का नाम/ Name of the applicant</div>
							...
							<div className="row" style={{fontSize:"14px", minHeight:"38.6px"}}>
								<div className="col-6" style={{ textAlign: "left", border: "1px solid" }}>
									6. र्वद कोई, िवववाि औि अवकाश, छुट्टी सेपूवार्ा पश्ाात म /वलए जा िहे हैं
									<br></br>
								...
								<div className="col-6" style={{ textAlign: "left" }}>
									...
									<div className="row" style={{fontSize:"14px", minHeight:"38.6px"}}>
										<div className="col-2" style={{ textAlign: "left", border: "1px solid", fontSize: "14px" }}>
											के पश् ाात
											<br />
											Suffix
										</div>
							...
							<div className="row" style={{fontSize:"14px", minHeight:"38.6px"}}>
								...
								<div className="col-6" style={{ textAlign: "left", border: "1px solid" }}>{leave?.purpose}</div>
							</div>
							<div className="row" style={{fontSize:"14px", minHeight:"38.6px"}}>
								<div className="col-6" style={{ textAlign: "left", border: "1px solid" }}>
							...
							<div className="row" style={{ border: "1px solid", fontSize:"14px", minHeight:"38.6px" }}>
								<div className="col-12" style={{ textAlign: "left" }}>
									9. मैं_______________ब्लॉक वर्ाकी छुट्टी केदौिान छुट्टी र्ात्रा रिर्ार्त लेनेहतेुइच्छुक ह ूँ/ नहीं ह ूँ। / I propose/do not propose to avail myself of Leave Travel Concession
									for the block years__________________ during the leave.
								</div>
							</div>
							...
							<div className="row" style={{fontSize:"14px", minHeight:"38.6px"}}>
								...
								<div className="col-6" style={{ textAlign: "left" }}>
									...
									<div className="row" style={{ height: "38px", fontSize:"14px", minHeight:"38.6px" }}>
										<div className="col-8" style={{ textAlign: "left", border: "1px solid", fontSize: "14px" }}>
											<p></p>
										</div>
										<div className="col-4" style={{ textAlign: "left", border: "1px solid", fontSize: "14px" }}>
											वपन/PIN:
							...
							<div className="row" style={{fontSize:"14px", minHeight:"38.6px"}}>
								<div className="col-6" style={{ textAlign: "left", border: "1px solid" }}>
									11. क्र्ा स्टेशन छोड़ने की आवश्र्कता है/Whether Station leave is required
								</div>
								<div className="col-6" style={{ textAlign: "left" }}>
						...
						<div>
							<p style={{ fontWeight: "bold", textDecoration: "underline	" }}>लनयंत्रक अलर्कारी की लिप्पणी एवंलसफाररश/ Remarks and Recommendations of the controlling officer</p>
							<div className="row">
						...
						>
							<p>
								<b style={{ textDecoration: "underline" }}>
									प्रशासलनक अनुभाग द्वारा प्रयोग हेतु/ For use by the Administration Section
								</b>
							</p>
							<p style={{ textAlign: "left" }}>
								प्रमावित वकर्ा जाता है वक _______________ से ______________की______________(अववध) के वलए______________(छुट्टी का प्रकाि) वनम्न वदए गए ववविि केअनुसाि स्वीकाि की
								जाती है। Certified that ____________ (nature of leave) for_____________ period, from____________ To____________ is available as per following details:
							</p>
						...
						<div className="footer">
							<div className="row" style={{textAlign:"right"}}>
								...
								<div className="col-8" >
									...
									<br/>
									<p style={{color:"green", fontWeight:"bold"}}>{leave?.status}</p>
								</div>
							</div>
							<br />
							<br />
